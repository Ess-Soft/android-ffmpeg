...
void Java_com_atonality_ffmpeg_FFmpegInvoke_run(JNIEnv* env, jobject obj, jstring libffmpeg_path, jobjectArray ffmpeg_args)
{
	const char* path;
	void* handle;
	...
	Java_com_atonality_ffmpeg_FFmpeg_run = dlsym(handle, "Java_com_atonality_ffmpeg_FFmpeg_run");
